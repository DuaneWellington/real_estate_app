...
from . import views
from .views import realty_data_view, contact_view, search_view, results_view, register, CustomLoginView, new_listings, new_rentals, property_detail, auto_complete_view
