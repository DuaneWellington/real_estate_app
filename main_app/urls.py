...
from . import views
from .views import contact_view, register, profile, new_listings, new_rentals, property_detail, results, property_photos, folder_create, folder_detail, folder_update, listing_toggle_favorite, listing_delete, folder_delete
